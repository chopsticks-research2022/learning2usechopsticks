...
class PPO_Dataset(Dataset):
    def __init__(self, data):
        self.size = data["samples"]
        samples = self.size
        self.observation = data["obs"][:samples]
        self.action      = data["acs"][:samples]
        self.advantage   = data["advs"][:samples]
        self.vtarget     = data["vtargs"][:samples]
        self.log_pact    = data["a_logps"][:samples]
